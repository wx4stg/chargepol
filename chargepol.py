...
def write_output(filename_output, pos_time, pos_zmin, pos_zwid, pos_flax, pos_flay, pos_fla_lon, pos_fla_lat, pos_fla_id, neg_time, neg_zmin, neg_zwid, neg_flax, neg_flay, neg_fla_lon, neg_fla_lat, neg_fla_id):
    ...
    pos_fla_id = np.array(pos_fla_id, np.dtype(np.uint64))
    ...
    neg_fla_id = np.array(neg_fla_id, np.dtype(np.uint64))

    e = open(filename_output, 'a')
    e.write("# Generated by ChargePol\n")
    e.write("#charge (pos/neg), time (UT sec), bottom height of layer (km), depth of layer (km), x distance from LMA center (km), y distance from LMA center (km), longitude, latitude, flash ID\n")
    e.write("charge,time,zmin,zwidth,x,y,lon,lat,id\n")
    for f in np.arange(0,len(pos_time)):
        e.write("pos,%f,%f,%f,%f,%f,%f,%f,%d\n" % (pos_time[f, 0], pos_zmin[f, 0], pos_zwid[f, 0], pos_flax[f, 0], pos_flay[f, 0], pos_fla_lon[f, 0], pos_fla_lat[f, 0], pos_fla_id[f, 0]))

    for g in np.arange(0,len(neg_time)):
        e.write("neg,%f,%f,%f,%f,%f,%f,%f,%d\n" % (neg_time[g, 0], neg_zmin[g, 0], neg_zwid[g, 0], neg_flax[g, 0], neg_flay[g, 0], neg_fla_lon[g, 0], neg_fla_lat[g, 0], neg_fla_id[g, 0]))
...
if __name__ == '__main__':
    ...
    write_out = write_output(filename_output, pos_time, pos_zmin, pos_zwid, pos_flax, pos_flay, pos_fla_lon, pos_fla_lat, pos_fla_id, neg_time, neg_zmin, neg_zwid, neg_flax, neg_flay, neg_fla_lon, neg_fla_lat, neg_fla_id)
